...
public class EmployeePayrollController {
	...
	@PutMapping("/update")
	public ResponseEntity<String> updateEmployeePayrollData(@RequestBody EmployeePayrollDTO emPayrollDTO) {
		return new ResponseEntity<String>("Updated Employee Payroll Data for: "+emPayrollDTO, HttpStatus.OK);
	}
